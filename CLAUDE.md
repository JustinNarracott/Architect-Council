...
providers + 1 local model for diverse, grounded architecture reviews.
...
- Uses 5 different LLMs (OpenAI, Anthropic, Perplexity, Ollama) for diverse perspectives
...
| Security Analyst    | Qwen3 Coder 30B   | Ollama     | Local GPU   |
